...
//{
//  static QString fmt = QString::fromUtf16(L"\x226a%1\xff0f%2\x226b");
...
//    return text;
//  static QRegExp rx(QString::fromUtf16(L"\x226a(.+)\xff0f.+\x226b"));
//  if (!rx.isMinimal())
//    rx.setMinimal(true);
...
namespace Private {
  bool hookBefore(winhook::hook_stack *s)
  {
    ...
    if (reladdr == 0x25660 || reladdr == 0x28301)
      return true;
    auto role = Engine::OtherRole;
    QString oldText = QString::fromUtf16(text),
...
namespace Private {
  ...
  HookArgument * __fastcall newHookFun(void *ecx, void *edx, ULONG offset1, ULONG offset2)
  {
    ...
    if (arg && arg->isValid()) {
      ...
      auto sig = split;
      QString oldText = QString::fromUtf16(arg->text),
